...
export default function QuotaExceededBanner({ resetDate }: QuotaExceededBannerProps) {
  ...
  return (
    <div className="sticky top-[120px] z-40 px-4 pb-4">
      <GlassPanel className="rounded-[16px] px-6 py-4 border-2 border-border-panel-strong bg-notice relative">
        {/* Close Button */}
        <button
          onClick={handleDismiss}
          className="absolute top-3 right-3 text-gold opacity-60 hover:opacity-100 transition-opacity"
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-shrink-0 mt-1">
            <div className="w-10 h-10 rounded-full bg-notice border border-border-panel-strong flex items-center justify-center">
              <svg
          ...
          <div className="flex-1 pr-8">
            ...
            <div className="space-y-2 text-sm text-text-muted leading-relaxed">
              ...
              <p>
                ...
                <span className="font-semibold text-gold">{formattedDate}</span>.
              </p>
              <p className="italic text-text-subtle">
