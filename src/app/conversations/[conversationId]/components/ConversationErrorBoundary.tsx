...
/**
 * Conversation-specific Error Boundary with navigation fallback.
 * Single Responsibility: Handle conversation-specific errors with contextual recovery.
 */
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  This conversation encountered an error. You can try again or
